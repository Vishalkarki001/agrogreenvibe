          ...
          <Reveal delay={120}>
            ...
            <div className="mt-5 space-y-4 text-base leading-relaxed text-slate-600">
              <p>
                ...
                belief — that <strong className="font-semibold text-slate-800">everyone
      ...
      <section className="bg-green-50/60 py-20 lg:py-24">
        <Container>
          <div className="grid gap-6 lg:grid-cols-2">
            <Reveal>
              <div className="flex h-full flex-col rounded-2xl border border-green-100 bg-white p-8 shadow-sm">
            ...
            <Reveal delay={120}>
              <div className="flex h-full flex-col rounded-2xl border border-amber-100 bg-white p-8 shadow-sm">
            ...
            {VALUES.map((value, i) => {
              ...
              return (
                <Reveal key={value.title} delay={i * 100}>
                  <div className="flex h-full flex-col items-center rounded-2xl bg-white p-7 text-center shadow-sm ring-1 ring-slate-100">
                    <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-green-50 text-green-700">
                      <Icon className="h-7 w-7" />
                    </span>
                    <h4 className="mt-5 font-display text-lg font-bold text-slate-900">
                      {value.title}
                    </h4>
