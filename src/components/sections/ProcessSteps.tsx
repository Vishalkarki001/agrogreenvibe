    ...
    <section className="bg-green-50/60 py-20 lg:py-24">
      <Container>
        ...
        <div className="relative mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div
            className="absolute left-0 right-0 top-8 hidden h-0.5 bg-green-200 lg:block"
            aria-hidden
          />
            ...
            return (
              <Reveal key={step.step} delay={i * 120}>
                <div className="relative flex flex-col items-center text-center">
                  <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-md shadow-green-900/5 ring-1 ring-green-100">
                    <Icon className="h-7 w-7 text-green-700" aria-hidden />
